...
import UpdateUsername from "../components/UpdateUserCreds";
...
describe("UpdateUsername Component", () => {
    ...
    test('hides input fields when "Cancel" button is clicked', () => {
        ...
        expect(
            screen.queryByPlaceholderText(/enter new username/i)
    ...
    test("displays error message when update fails", () => {
        ...
        setTimeout(() => {
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                expect.stringContaining("Error updating username")
            );
            expect(
                screen.getByText(
                    /failed to update username. please try again./i
                )
            ).toBeInTheDocument();
